...
$nmahasiswa = new Mahasiswa("Data Warehouse", 0, 0);

if (isset($_POST['tombol'])) {

  $nmahasiswa->matakuliah = $_POST['matkul'];
  $nmahasiswa->nim = $_POST['nim'];
  $nmahasiswa->nilai = $_POST['nilai'];
}
...
<body>
  <div class="container">
    ...
    <div class="container-fluid">
      <hr>
      <div class="row mx-1">
        <span>Nim: <?= $nmahasiswa->nim; ?> </span>
        <span>Nama Mata kuliah: <?= $nmahasiswa->matakuliah; ?> </span>
        <span>Nilai : <?= $nmahasiswa->nilai; ?> </span>
        <span>Hasil Ujian: <?= $nmahasiswa->hasil(); ?></span>
        <span>Grade: <?= $nmahasiswa->grade(); ?> </span>
      </div>
      <hr>
    </div>
